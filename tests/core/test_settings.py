...
def test_check_str_is_http():
    assert check_str_is_http("http://localhost") == "http://localhost/"
    assert check_str_is_http("https://localhost") == "https://localhost/"
    # Non-URL inputs need to be full URLs
    # assert check_str_is_http("localhost") == "http://localhost/"
...
#     assert settings.AVAILABLE_MODELS == {OpenAIModelName.GPT_4_TURBO}
